...
class BankAccount extends Component {
    ...
    static getDerivedStateFromProps(nextProps, prevState) {
        if (prevState.isGetData && nextProps.bankInfor && nextProps.bankInfor !== prevState.bankInfor) {
    ...
    errorHandle() {
        ...
        if (JSON.stringify(this.state.bankInfor) === JSON.stringify(fistValuebankInfor)) {
            return (
                <div className="alert alert-danger" role="alert">
                    ...
                    <Form.Item>
                        <Button type="primary" htmlType="submit"
                            disabled={
                                ...
                                JSON.stringify(this.state.bankInfor) === JSON.stringify(fistValuebankInfor)
                                || this.state.isEmpty
                            }
                            loading={pending}
                        >
