...
class VerifyPassword extends React.Component {
    ...
    render() {
        ...
        const active = email && code && password.trim() && password === retypePassword;
        return (
...
const mapDispatchToProps = (dispatch) => ({
    forgotPassword: (email, code, password) => dispatch(userActions.forgotPassword(email, code, password)),
});
