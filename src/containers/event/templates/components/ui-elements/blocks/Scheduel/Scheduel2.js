...
class Scheduel2 extends Component {
    ...
    render() {
        ...
        const { scheduelText, margin, padding, scheduelName,
                    ...
                    <div >
                        {scheduelText.map((scheduel, index) =>
                            <div className="child-block" key={index}>
                                {editable && <div><PlusCircleTwoTone className="ml-1 "
                                    onClick={() => this.onClickAddScheduel(scheduel.id)}
                                />
                                    <DeleteTwoTone className="ml-3 " onClick={() => this.removeOption(scheduel)} />
                                </div>
                                }
